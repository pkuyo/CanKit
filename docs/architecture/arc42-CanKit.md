...
| L4 Anwendungsprotokolle | UDS-MVP vorhanden (`CanKit.Pro.Uds`), Rest NEU | Diagnose-/Applikationssemantik auf L3/L2. | `IUdsClient`/`UdsClient` (UDS), sonst neu, protokollspezifisch | `FR-UDS-*`, `FR-CO-*`, `FR-J1939-*`, `FR-HAWE-*` |
