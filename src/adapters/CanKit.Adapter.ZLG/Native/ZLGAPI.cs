...
namespace CanKit.Adapter.ZLG.Native
{
    ...
    public class ZLGCAN
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static unsafe extern uint ZCAN_TransmitData(ZlgDeviceHandle device_handle, ZCANDataObj* pTransmit, uint len);
        [DllImport(DllName, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static unsafe extern uint ZCAN_TransmitData(IntPtr device_handle, ZCANDataObj* pTransmit, uint len);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static unsafe extern uint ZCAN_ReceiveData(ZlgDeviceHandle device_handle, [In, Out] ZCANDataObj[] pReceive, uint len, int wait_time);
        [DllImport(DllName, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static unsafe extern uint ZCAN_ReceiveData(IntPtr device_handle, [In, Out] ZCANDataObj[] pReceive, uint len, int wait_time);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern void ZCLOUD_SetServerInfo(string httpSvr, ushort httpPort, string mqttSvr, ushort mqttPort);
        ...
        public unsafe struct ZCANCANFDData
        {
            ...
            {
                get =>  (flag >> 2) & 0x03u;
                set =>  flag = (flag & ~0x0Cu) | ((value & 0x03u) << 2);
            }
