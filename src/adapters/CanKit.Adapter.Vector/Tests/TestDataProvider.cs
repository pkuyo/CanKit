...
public class TestDataProvider : ITestDataProvider
{
    ...
    [
        ...
        (CanFrame.Fd(0x1ABCDEFF, new byte[] { 0x5, 0x1 }, true, false, true), TimeSpan.FromMilliseconds(5), 10)
    ];
    ...
    public Action<IBusInitOptionsConfigurator>? TestBusInitFunc { get; } = (cfg) =>
    {
        ...
        {
            v.ReceiveBufferCapacity(32767).PollingInterval(1);
        }
    };
}
