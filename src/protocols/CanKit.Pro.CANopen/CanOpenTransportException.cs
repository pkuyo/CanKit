...
/// perspective, so there is no single request task to fail.
/// </summary>
public sealed class CanOpenTransportException : Exception
{
    /// <summary>Constructs a new exception with the given <paramref name="message"/>.</summary>
    public CanOpenTransportException(string message) : base(message) { }

    /// <summary>Constructs a new exception wrapping <paramref name="inner"/>.</summary>
    public CanOpenTransportException(string message, Exception inner) : base(message, inner) { }
}
